...
```sh
pkill -x hotlist2 2>/dev/null
pkill -x Hem 2>/dev/null
xcodebuild -project hotlist2.xcodeproj -scheme hotlist2 -configuration Release -derivedDataPath .derivedData -destination 'platform=macOS' build
